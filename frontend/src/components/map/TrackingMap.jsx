...
const patientIcon = new L.DivIcon({
  html: '<div class="patient-marker" style="background-color: #ef4444; width: 24px; height: 24px; border-radius: 50%; border: 3px solid white; box-shadow: 0 0 10px rgba(239,68,68,0.5);"></div>',
  className: '',
  iconSize: [24, 24],
  iconAnchor: [12, 12],
});
...
const ambulanceIcon = new L.DivIcon({
  html: '<div class="ambulance-marker" style="font-size: 24px; filter: drop-shadow(0 0 5px rgba(0,0,0,0.5));">🚑</div>',
  className: '',
  iconSize: [30, 30],
  iconAnchor: [15, 15],
});
...
const hospitalIcon = new L.DivIcon({
  html: '<div class="hospital-marker" style="font-size: 24px; filter: drop-shadow(0 0 5px rgba(0,0,0,0.5));">🏥</div>',
  className: '',
  iconSize: [30, 30],
  iconAnchor: [15, 15],
});
